...
#for x1, b sq - 4ac eq 5
#mb p sq b sq - 4ac eq 3 pl sq 5


x1 = div(sub(neg(b), sqrt(sub(exp(b, 2), mult(4, mult(a, c))))), mult(2, a)) # TODO: write a code to compute the first root of the quadratic equation
x2 = div(add(neg(b), sqrt(sub(exp(b, 2), mult(4, mult(a, c))))), mult(2, a)) # TODO: then do the same for the second root
